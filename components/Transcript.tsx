  ...
  return (
    <div className="max-w-3xl mx-auto py-10">
      <div className="prose prose-stone max-w-none">
        <p className="font-serif text-lg text-black/80 leading-relaxed first-letter:text-[3.5rem] first-letter:font-bold first-letter:float-left first-letter:mr-3 first-letter:text-[var(--secondary)] first-letter:leading-[1]">
          Thank you! Hello, Class of 2024! It is an incredible feeling to be here
        ...
        <div className="mt-8 pt-8 border-t border-black/5 space-y-6">
           <p className="text-lg font-serif italic text-black/80 leading-relaxed">
             I graduated from tennis recently. I know the word is &ldquo;retire.&rdquo; &ldquo;Roger Federer retired from tennis.&rdquo; Retired... The word is awful. You would not say you retired from college, right? Like you, I am figuring out what is next.
           </p>
           <p className="text-lg font-serif italic text-black/80 leading-relaxed">
